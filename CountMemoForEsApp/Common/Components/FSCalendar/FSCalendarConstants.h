...
#define FSCalendarStandardSelectionColor   FSColorRGBA(48,196,164,1.0)
#define FSCalendarStandardTodayColor       FSColorRGBA(255,0,0 ,0.3)
#define FSCalendarStandardTitleTextColor   FSColorRGBA(0,0,0 ,0.7)
